...
public class TreeRenderer extends DefaultTreeCellRenderer {
	...
	static {
		java.net.URL imageURL = NetworkManagerGUI.class
				.getResource("icons/mrtg.png");
		MRTG_ICON = new ImageIcon(imageURL);
		imageURL = NetworkManagerGUI.class.getResource("icons/router.png");
		ROUTER_ICON = new ImageIcon(imageURL);
		imageURL = NetworkManagerGUI.class.getResource("icons/link.png");
		LINK_ICON = new ImageIcon(imageURL);
		INACTIVE_ROUTER_ICON = new ImageIcon(ColorIcon.colorize(ROUTER_ICON
				.getImage(), Color.red));
		INACTIVE_LINK_ICON = new ImageIcon(ColorIcon.colorize(LINK_ICON
				.getImage(), Color.red));
