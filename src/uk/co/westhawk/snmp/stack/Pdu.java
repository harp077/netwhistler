...
public abstract class Pdu extends Observable
{
    ...
    private final static String TIMED_OUT = "SNMP: Timed out";
    private final static String [] errorStrings =
    {
        "SNMP: No error",
        "SNMP: Value too big error",
        "SNMP: No such name error",
        "SNMP: Bad value error",
        "SNMP: Read only error",
        "SNMP: General error",
        "SNMP: No access error",
        "SNMP: Wrong type error",
        "SNMP: Wrong length error",
        "SNMP: Wrong encoding error",
        "SNMP: Wrong value error",
        "SNMP: No creation error",
        "SNMP: Inconsistent value error",
        "SNMP: Resource unavailable error",
        "SNMP: Commit failed error",
        "SNMP: Undo failed error",
        "SNMP: Authorization error",
        "SNMP: Not writable error",
        "SNMP: Inconsistent name error",
    };
