...
class ButtonPanel extends JPanel implements ActionListener {
  ...
  ButtonPanel(VncViewer v) {
    ...
    disconnectButton.setBackground(NetworkManagerGUI.sysBackColor);
    disconnectButton.setFont(NetworkManagerGUI.baseFont);
    disconnectButton.setEnabled(false);
    add(disconnectButton);
    disconnectButton.addActionListener(this);
    optionsButton = new JButton("Options");
    optionsButton.setBackground(NetworkManagerGUI.sysBackColor);
    optionsButton.setFont(NetworkManagerGUI.baseFont);
    add(optionsButton);
    optionsButton.addActionListener(this);
    clipboardButton = new JButton("Clipboard");
    clipboardButton.setBackground(NetworkManagerGUI.sysBackColor);
    clipboardButton.setFont(NetworkManagerGUI.baseFont);
    clipboardButton.setEnabled(false);
    add(clipboardButton);
    clipboardButton.addActionListener(this);
    if (viewer.rec != null) {
      recordButton = new JButton("Record");
      recordButton.setBackground(NetworkManagerGUI.sysBackColor);
      recordButton.setFont(NetworkManagerGUI.baseFont);
      add(recordButton);
      recordButton.addActionListener(this);
    }
    ctrlAltDelButton = new JButton("Send Ctrl-Alt-Del");
    ctrlAltDelButton.setBackground(NetworkManagerGUI.sysBackColor);
    ctrlAltDelButton.setFont(NetworkManagerGUI.baseFont);
    ctrlAltDelButton.setEnabled(false);
    add(ctrlAltDelButton);
    ctrlAltDelButton.addActionListener(this);
    refreshButton = new JButton("Refresh");
    refreshButton.setBackground(NetworkManagerGUI.sysBackColor);
