...
class RecordingFrame extends JFrame
  ...
  RecordingFrame(VncViewer v) {
    ...
    browseButton.setBackground(NetworkManagerGUI.sysBackColor);
    browseButton.setFont(NetworkManagerGUI.baseFont);
    ...
    nextButton.setBackground(NetworkManagerGUI.sysBackColor);
    nextButton.setFont(NetworkManagerGUI.baseFont);
